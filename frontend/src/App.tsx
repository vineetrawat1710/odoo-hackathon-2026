  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#fafbfc]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden ml-64">
        <Navbar />
        <main className="flex-1 overflow-y-auto pt-16 px-8 py-8 dotted-bg">
          <Outlet />
        </main>
      </div>
    </div>
    ...
    <BrowserRouter>
      <ToastProvider>
        <Routes>
          ...
          {/* 404 fallback */}
          <Route path="*" element={
            <div className="min-h-screen bg-[#fafbfc] dotted-bg flex flex-col items-center justify-center text-center font-sans">
              ...
              <a href="/dashboard" className="mt-6 px-5 py-2.5 bg-indigo-600 text-white text-sm font-semibold rounded-[10px] hover:bg-indigo-700 shadow-crystal-btn hover:shadow-crystal-btn-hover hover:-translate-y-px transition-all duration-200">
                Return to Dashboard
              </a>
            </div>
          } />
